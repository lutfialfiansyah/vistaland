        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit NUP</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="{{ route('nup.update',$edit->id) }}" method="post">
              {!! csrf_field() !!}
                ...
                <div class="form-group {{ $errors->has('project') ? ' has-error' : ''}}">
                  ...
                  <select name="project" id="project" class="form-control" >
                    <option value="{{ $edit->project_id }}">{{ $project->name }}</option>
                ...
                <div class="form-group {{ $errors->has('customer') ? ' has-error' : ''}}">
                  ...
                  <select name="customer" id="customer" class="form-control">
                    <option value="{{$edit->customer_id}}" selected="selected">
                    {{ $edit->customer->code." - ".$edit->customer->first_name." ".$edit->customer->last_name }}</option>
