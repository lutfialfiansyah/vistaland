...
@section('konten')
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ URL::to('/users/edit',$edit->id) }}">Edit Users</a></li>
      </ol>
    </section>
       ...
       <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            @endif
              <form action="{{ route('official.update',$edit->id) }}" method="post">
							...
							<div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
								...
								<select name="role" class="form-control">
									<option value="{{ $edit->role }}" selected="selected">{{ $edit->role }}</option>}
									<option disabled="disabled"></option>
							...
							<div class="form-group">
								<a href="{{ route('official.view') }}" class="btn btn-danger" onclick="return confirm('Clik OK to confirm !')">BATAL</a>
