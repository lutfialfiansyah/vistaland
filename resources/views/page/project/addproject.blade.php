            ...
            <div class="box-body">
              ...
              {!! csrf_field() !!}
                ...
                <div class="form-group{{ $errors->has('unit_total') ? ' has-error' : '' }}">
                  ...
                  <input type="number" name="unit_total" class="form-control" value="{{ old('unit_total') }}">
                ...
                <div class="form-group{{ $errors->has('nup_free') ? ' has-error' : '' }}">
                  ...
                  <input type="number" name="nup_free" class="form-control" value="{{ old('nup_free') }}">
                ...
                <div class="form-group{{ $errors->has('nup_comission') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="nup_comission" class="form-control" value="{{ old('nup_comission') }}">
                ...
                <div class="form-group{{ $errors->has('booking_free') ? ' has-error' : '' }}">
                  ...
                  <input type="number" name="booking_free" class="form-control" value="{{ old('booking_free') }}">
                ...
                <div class="form-group{{ $errors->has('akad_comission') ? ' has-error' : '' }}">
                  ...
                  <input type="number" name="akad_comission" class="form-control" value="{{ old('akad_comission') }}">
